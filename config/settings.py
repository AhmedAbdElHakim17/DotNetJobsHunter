...
_keywords = os.getenv("LINKEDIN_KEYWORDS", "backend, fullstack, developer, .net")
LINKEDIN_KEYWORDS = [k.strip() for k in _keywords.split(",") if k.strip()]

_locations = os.getenv("LINKEDIN_LOCATIONS", "Egypt, Saudi Arabia, UAE, Qatar, Bahrain, Oman, Dubai, United States")
